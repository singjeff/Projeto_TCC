...
deleta_usuario = metodo_deleta_usuario.deleta_usuario(db)
...
def cadastrar_fornecedor():
    ...
    incricao = request.form['cnpj']
    data_cadastro = None
    ind_fornecedor = None
    ind_cliente = None
    ind_funcionario = None
    att_pessoa= Pessoa(id_pessoa, id_tipo_pessoa, nome, incricao, data_cadastro, ind_cliente, ind_funcionario,ind_fornecedor )
