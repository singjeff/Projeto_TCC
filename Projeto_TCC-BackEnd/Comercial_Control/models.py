...
class Pessoa:
    def __init__(self, id_pessoa, id_tipo_pessoa, nome, incricao, data_cadastro,\
         ind_cliente, ind_funcionario, ind_fornecedor):
         self.id_pessoa = id_pessoa
         self.id_tipo_pessoa = id_tipo_pessoa
         self.nome = nome
         self.incricao = incricao
...
class exibe_usuario:
    def __init__(self,cod_usuario, id_tipopessoa, email_usuario, nome_usuario, dt_cadastro):
        self.cod_usuario = cod_usuario
        self.email_usuario = email_usuario
        self.nome_usuario = nome_usuario
        self.id_tipopessoa = id_tipopessoa
