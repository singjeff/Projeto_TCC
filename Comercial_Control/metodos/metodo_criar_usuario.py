...
SQL_CADASTRAR_USUARIO = 'insert into Usuario (cod_usuario,nome_usuario,  senha_aplicacao) values (?, ?, ?)'
...
SQL_DT_SYSTEM = 'CONVERT (date, SYSDATETIME())'
...
class cadastrar_usuario:
    ...
    def cadastra_usuario(self, usuario,Pessoa,Endereco_Pessoa,ContatoPessoa):
        ...
        cursor.execute(SQL_CADASTRAR_USUARIO, (usuario.cod_usuario, usuario.nome_usuario, usuario.senha_aplicacao))
