...
from metodos import metodo_login, metodo_criar_usuario, metodo_att_usuario, metodo_buscar_usuario, metodo_deleta_usuario, metodo_criar_fornecedor, metodo_cadastrar_categoria, metodo_cadastrar_marca
from models import Usuario,Pessoa,Endereco_Pessoa,ContatoPessoa, exibe_usuario, Fornecedor, Funcionario, Categoria_Produto, Marca_Produto
...
def gerenciar_Estoque():
    ...
    return render_template('DashBoard/area_adminstrador/gerenciar_Estoque.html',lista_categoria= listaCategoria, lista_marca= listaMarca)
...
def caixa():
    ...
    return render_template('DashBoard/area_usuario/caixa.html')
