...
from metodos import metodo_login, metodo_criar_usuario, metodo_att_usuario, metodo_buscar_usuario, metodo_deleta_usuario, metodo_criar_fornecedor, metodo_cadastrar_categoria
from models import Usuario,Pessoa,Endereco_Pessoa,ContatoPessoa, exibe_usuario, Fornecedor, Funcionario, Categoria_Produto
...
def gerenciar_Estoque():
    ...
    return render_template('DashBoard/area_adminstrador/gerenciar_Estoque.html',lista_categoria= listaCategoria)
